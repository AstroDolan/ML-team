...
* Fecha: 23/12/2024                                                       *
*                                                                         *
* Compilacion: gcc -o maze9.exe maze9.c                                   *
* Ejecucion con perf:                                                     *
* perf stat -e task-clock,cycles,instructions,power/energy-pkg/ ./maze9   *
*                                                                         *
**************************************************************************/
...
#define N 9 //Al intentar con 305, el codigo no funciona.
#define MAX_SIZE 55 //Tamaño máximo para path y visited
