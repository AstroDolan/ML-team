...
\author{Dylan Jara}
\title[Modelamiento de Lahares Mediante PINNs]{Modelamiento de Lahares Mediante Redes Neuronales Informadas por la Física (PINNs): Aplicacion al 
Evento Eruptivo de 2015 del Volcán Villarica, Chile}
\subtitle{}
\institute{
