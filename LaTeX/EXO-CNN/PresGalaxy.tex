...
\begin{frame}{Dataset Galaxy Zoo}
    \begin{itemize}
        ...
        \item<2-> En este trabajo, usamos Galaxy Zoo \cite{lintott2008galaxy,willett2013galaxy} para la clasificacion y validacion de nuestros modelos de clasificacion.
        \item<3-> El projecto original Galaxy Zoo fue lanzado en julio de 2007 y obtuvo mas de 100,000 voluntarios en sus primeros diez dias.
        \item<4-> Los voluntarios clasificaron imagenes del Sloan Digital Sky Survey (SDSS) de galaxias en seis categorias: eliptica, espiral en sentido horario, 
...
\begin{frame}{Ideas Futuras}
    \begin{itemize}
        ...
        \item Usar la CNN para extración de datos y clasificar con Decision Tree, SVM o Random Forest. \cite{agarap2019architecturecombiningconvolutionalneural}
    \end{itemize}
\end{frame}
