...
\begin{frame}{Introducción al problema}
    \begin{itemize}
        \item<1-> Usaremos una CNN que categoriza 37 clases
        \item<2-> Dataset de galaxy zoo, con probs de clase por id
        \item<3-> Se debe explicar las galaxias y sus categorias. Las CNN se explican en metodologia
    \end{itemize}
\end{frame}
