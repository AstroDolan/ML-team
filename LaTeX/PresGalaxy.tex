...
\section{Descripcion de datos de estudio} %Buraian
...
\subsection{Analisis preliminar y exploratorio de los datos}
\begin{frame}
    \begin{itemize}
        \item Se uso data augmentation para rotar las imagenes
    \end{itemize}
\end{frame}
...
%/////////////////////////////////////////////%
\section{Esquema Metodologico} %Brian
...
\section{Refs} %Quitar porque sirven para traduccion
\begin{frame}
    \begin{itemize}
