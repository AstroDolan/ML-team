...
\begin{frame}{Qué son los lahares?}
    \begin{itemize}
        ...
        The term comes from the Indonesian word for these destructive mudflows that cause both property damage and loss of life.
        \item<3-> Importancia de su estudio, desastres, etc
    \end{itemize}
\end{frame}
